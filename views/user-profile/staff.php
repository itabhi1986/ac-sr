...
<div class="staff-gallery-form">
    ...
    <?= $form->field($model, 'sub_tittle')->textInput(['maxlength' => true]) ?>
        ...
        <?= Html::submitButton($model->isNewRecord ? 'Upalad Images' : 'Update', ['class' => $model->isNewRecord ? 'btn btn-md btn-success' : 'btn btn-primary']) ?>
...
<div class="col-md-12">
 <div class="pic-thum">
                    <?php
                                if(isset($staffImages)&& count($staffImages)>0)
                                {
                                   foreach($staffImages as $key=>$value)
                                   {
                                       ?>
